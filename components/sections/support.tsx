...
import { Headphones, MessageCircle, Clock, Shield, Heart, ArrowRight } from "lucide-react";
...
const supportFeatures = [
  {
    ...
    description: "We're here when you need us. Reach out anytime—we respond within 24 hours, often much sooner.",
  },
  {
    icon: MessageCircle,
    title: "Direct Communication",
    description: "No ticket systems or automated responses. Talk directly to the team that built your product.",
  },
  {
    icon: Clock,
    title: "Quick Response",
    description: "Urgent issues? We prioritize and respond fast. Your success is our priority.",
  },
  {
    icon: Shield,
    title: "Long-term Partnership",
    description: "We don't disappear after launch. We're committed to your long-term success and growth.",
  },
];
...
export function Support() {
  ...
  return (
    <section id="support" className="py-20 lg:py-32 bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-primary-foreground/80 leading-relaxed mb-8">
            Launch day is just the beginning. We're your long-term technology partner, here to help you grow, iterate, and succeed. Whether it's a bug fix, a new feature, or strategic advice—we're always just a message away.
          </p>
