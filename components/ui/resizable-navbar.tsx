...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "hidden lg:flex",
        "relative z-60 mx-auto w-full max-w-7xl flex-row items-center justify-between self-start rounded-full bg-background/40 backdrop-blur-xl border border-border/50 px-4 py-2 shadow-lg",
        className,
      )}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "flex lg:hidden",
        "relative z-50 mx-auto w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-background/40 backdrop-blur-xl border border-border/50 rounded-full px-0 py-2 shadow-lg",
        className,
      )}
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <X className="text-foreground cursor-pointer" onClick={onClick} />
  ) : (
    <Menu className="text-foreground cursor-pointer" onClick={onClick} />
  );
};
